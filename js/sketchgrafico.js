...
function preload(){
  data = loadJSON("https://api.myjson.com/bins/16gj82");
}
...
function setup() {
  ...
  botonFelipeSanchez.position(1300,180);
  ...
  botonTomasLopez.position(1300,250);
  ...
  botonFelipeCabello.position(1300,320);
  ...
  botonValentinaEspinoza.position(1300,390);
  ...
  botonDeianiraReyes.position(1300,460);
...
function draw() {
  ...
  botonRelleno.mousePressed(negro5);
  botonRelleno.mouseReleased(blanco5);
